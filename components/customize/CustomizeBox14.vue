...
<template>
  <div>
    <div class="box">
      <div class="premium" v-if="data.plan < 2">
        <h1>Premium+</h1>
      ...
      <div class="padding">
        ...
        <div class="info">
          <h4>discord.gg/{{ data?.discord[5]?.invite || "" }}</h4>
          <Icon name="ic:baseline-edit" id="modif" @click="openModal('5_discord')" />
        </div>
      </div>
    </div>
    <div class="modal" v-if="activeModal === '5_discord'">
      <div class="center">
